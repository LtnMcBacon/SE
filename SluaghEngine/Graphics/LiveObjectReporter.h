...
namespace SE {
	...
	namespace Graphics {
		...
		/**
		* @brief reportLiveObjects checks for DirectX memory leaks
		* @details reportLiveObjects is used to report live objects when exiting the application
		...
		*/
		...
		/**
		* @brief reportLiveObjects is used to set specific names for DirectX componenets for debugging with reportLiveObjects()
		* @details reportLiveObjects is used to report live objects when exiting the application
