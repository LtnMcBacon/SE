...
namespace SE
{
	namespace Gameplay
	{
		enum class Boons
		{
			CONDITIONAL_BOONS_NONE					= 0, 
			CONDITIONAL_BOONS_DAMAGE				= 1 << 0,
			CONDITIONAL_BOONS_KNOCKBACK				= 1 << 1,
			CONDITIONAL_BOONS_STUN					= 1 << 2,
			CONDITIONAL_BOONS_ROOT					= 1 << 3,
			CONDITIONAL_BOONS_PROTECTION			= 1 << 4,
			CONDITIONAL_BOONS_PHYSICAL_RESISTANCE	= 1 << 5,
			CONDITIONAL_BOONS_MAGICAL_RESISTANCE	= 1 << 6,
			CONDITIONAL_BOONS_FIRE_RESISTANCE		= 1 << 7,
			CONDITIONAL_BOONS_WATER_RESISTANCE		= 1 << 8,
			CONDITIONAL_BOONS_NATURE_RESISTANCE		= 1 << 9,
			CONDITIONAL_BOONS_CASTSPEED				= 1 << 10,
			CONDITIONAL_BOONS_SWIFTNESS				= 1 << 11,
			CONDITIONAL_BOONS_ATTACK_SPEED			= 1 << 12,
			CONDITIONAL_BOONS_INVULNERABILITY		= 1 << 13
		};

		enum class Banes
		{
			CONDITIONAL_BANES_NONE				= 0,
			CONDITIONAL_BANES_DAMAGE			= 1 << 0,
			CONDITIONAL_BANES_STUN				= 1 << 1,
			CONDITIONAL_BANES_ROOT				= 1 << 2,
			CONDITIONAL_BANES_BLOODLETTING		= 1 << 3,
			CONDITIONAL_BANES_UNCOVER			= 1 << 4,
			CONDITIONAL_BANES_PHYSICAL_WEAKNESS = 1 << 5,
			CONDITIONAL_BANES_MAGICAL_WEAKNESS	= 1 << 6,
			CONDITIONAL_BANES_FIRE_WEAKNESS		= 1 << 7,
			CONDITIONAL_BANES_WATER_WEAKNESS	= 1 << 8,
			CONDITIONAL_BANES_NATURE_WEAKNESS	= 1 << 9,
			CONDITIONAL_BANES_SLOW				= 1 << 10
		};
